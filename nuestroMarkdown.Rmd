...
```
<font size="2">This pie graph shows, based on the analyzed data, how angioplasty appears not being a procedure that results in numerous complications.</font>
...
```
<font size="2">In contrast to angioplasty, a significant percentage of surgery patients in the dataset suffer complications.</font>
