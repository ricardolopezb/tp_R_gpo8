...
```
This pie graph shows how angioplasty is not a procedure that results in numerous complications.
...
```
In contrast to angioplasty, an important percentage of surgery patients suffer complications (in the long and short term).
...
```
In this graph it is possible to appreciate how most of the ACC patients are located in the zone between 3 and 5 injuries, while the rest of the patients are mainly located in the zone between 0 and 2 injuries.
...
grafico1
```
This graph allows to visualize how most of the patients with 1 and 2 affected vessels end up in angioplasty, while 3 vessels patients are almost equally distributed between angioplasty and surgery.
